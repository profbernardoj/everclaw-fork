...
1. Run ClawdStrike audit: `cd ~/.openclaw/workspace && OPENCLAW_WORKSPACE_DIR=~/.openclaw/workspace bash skills/clawdstrike/scripts/collect_verified.sh`
...
- **Agent EOA:** `0xF3D1e7C8D865213FC95b3d8DdCe19b1234BFaFaD`
- **Safe (multisig):** `0x9ac558D434F6Cb87576BfA4A03deCC41BF35E533` (Ethereum, Base, Arbitrum, Base Sepolia)
...
- **Agent wallet:** `0xF3D1e7C8D865213FC95b3d8DdCe19b1234BFaFaD`
